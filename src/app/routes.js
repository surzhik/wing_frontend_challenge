...
import {
  sprintSubscriptionNavigate,
  attSubscriptionNavigate
} from "screens/Subscription/sagas";
import {
  sprintInsuranceConfirmNavigate,
  attInsuranceConfirmNavigate
} from "screens/InsuranceConfirm/sagas";
import {
  sprintInsurancePlanNavigate,
  attInsurancePlanNavigate
} from "screens/InsurancePlan/sagas";
import {
  sprintInsuranceNavigate,
  attInsuranceNavigate
} from "screens/Insurance/sagas";

export default buildRoutesMap(
  route(
    "SPRINT_INSURANCE_CONFIRM",
    "/s/subscriptions/:subId/insurance/:sku/:insPlanId/confirm",
    sprintInsuranceConfirmNavigate
  ),
  route(
    "SPRINT_INSURANCE_PLAN",
    "/s/subscriptions/:subId/insurance/:sku/select-plan",
    sprintInsurancePlanNavigate
  ),
  route(
    "SPRINT_INSURANCE",
    "/s/subscriptions/:subId/insurance",
    sprintInsuranceNavigate
  ),
  route(
    "ATT_INSURANCE_CONFIRM",
    "/a/subscriptions/:subId/insurance/:sku/:insPlanId/confirm",
    attInsuranceConfirmNavigate
  ),
  route(
    "ATT_INSURANCE_PLAN",
    "/a/subscriptions/:subId/insurance/:sku/select-plan",
    attInsurancePlanNavigate
  ),
  route(
    "ATT_INSURANCE",
    "/a/subscriptions/:subId/insurance",
    attInsuranceNavigate
  ),
  route(
    "SPRINT_SUBSCRIPTION",
    "/s/subscriptions/:subId",
    sprintSubscriptionNavigate
  ),
